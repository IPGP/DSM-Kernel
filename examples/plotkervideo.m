...
for t=3176:3400
filename=strcat('triplication23/',sprintf('%05d',t),'.00230.trikernel')
kernel=load(filename);
coordrs=load('coordrstri');
x=kernel(:,2);
y=kernel(:,1);
k=(kernel(:,4));
...
elseif(nview==2)
 ...
 filename=strcat('triplication23/jpg2/',sprintf('%05d',t),'.00230.jpg') ;
 %set(figure(1),'PaperPosition');
 saveas(figure(1),filename,'jpg');
 %filename=strcat('triplication23/pdf/',sprintf('%05d',t),'.00230.pdf') ;
